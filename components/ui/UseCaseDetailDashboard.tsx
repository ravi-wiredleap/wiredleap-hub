...
const getDummyMetrics = (usecaseId: string) => {
  const metricsMap: Record<string, any> = {
    ...
    "visual-crowd-management": {
      ...
      videoFeeds: [
        { id: 1, label: "Crowd Analysis", timestamp: "Live", image: "/images/usecases/Real-Time crowd-management/crowd-1.png" },
        { id: 2, label: "Feed 1", timestamp: "Live", image: "/images/usecases/Real-Time crowd-management/crowd-2.png" },
        { id: 3, label: "CM Visit", timestamp: "Live", image: "/images/usecases/Real-Time crowd-management/crowd-3.png" },
        { id: 4, label: "Rahul Gandhi", timestamp: "Live", image: "/images/usecases/Real-Time crowd-management/crowd-4.png" },
      ],
    },
